...
import com.classDojo.rest.jersey.JerseyResourceConfig;
...
public class JettyServer implements GenericServer {
	...
	public void start() throws Exception {
		...
		context.addFilter(com.classDojo.jetty.AuthenticationFilter.class, "/*", EnumSet.of(DispatcherType.REQUEST));
